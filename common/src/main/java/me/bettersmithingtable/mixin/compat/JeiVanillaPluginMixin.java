...
// Pseudo will spam the console a bit when JEI is not installed, but I can't be bothered to
// write a mixin config plugin.
@Pseudo
...
public class JeiVanillaPluginMixin {
    ...
    private void redirectSmithingClickArea(IGuiHandlerRegistration instance, Class<? extends HandledScreen<?>> clazz,
